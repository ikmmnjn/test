 ...
 * 복사하면서 submissions_ssis_post 자리를 기관 전용 테이블 이름(submissions_<코드>_post)으로
 * 바꿔 넣습니다.
 *
...
$pdo->exec("CREATE TABLE IF NOT EXISTS `$table` (
    ...
    work_sido VARCHAR(30) DEFAULT NULL,
    work_sigungu VARCHAR(30) DEFAULT NULL,
